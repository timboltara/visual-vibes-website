...
// Men's base: everything that isn't women's-only
...
export default function ForHimPage() {
  ...
  const results = applyFilters(mensBase, filters);
  ...
  return (
    <div className="pt-[129px] min-h-screen bg-white">
      <div className="px-5 sm:px-10 pt-10 pb-4 max-w-screen-xl mx-auto flex flex-col sm:flex-row sm:items-end justify-between gap-2">
        <div>
          <p className="font-heading text-[10px] uppercase tracking-widest text-vv-orange mb-1">Shop Men</p>
          <h1 className="font-heading font-black text-4xl sm:text-5xl uppercase text-vv-black leading-none">For Him</h1>
        </div>
