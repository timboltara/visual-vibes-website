...
// Faith Collection: scripture & faith-message focused designs
const faithProductIds = ["p1", "p2", "p11", "p12", "p14", "p15", "p18", "p19"];
const collectionProducts = products.filter((p) => faithProductIds.includes(p.id));
    ...
    <div className="pt-[129px] min-h-screen bg-white">
      ...
      <div className="relative bg-vv-black overflow-hidden" style={{ minHeight: "300px" }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-16 min-h-[300px]">
          <p className="font-heading text-vv-orange text-xs uppercase tracking-widest2 mb-3">Romans 1:16</p>
          <h1 className="font-heading font-black text-white uppercase leading-none" style={{ fontSize: "clamp(2.5rem, 8vw, 6rem)" }}>
            The Faith<br />Collection
          </h1>
          <p className="font-body text-gray-400 text-sm max-w-sm mx-auto mt-4">
            Scripture-inspired designs for the believer who carries their faith into every part of daily life.
          </p>
        </div>
      </div>
      ...
      <section className="bg-vv-black text-white py-16 px-6 text-center mt-8">
        <p className="font-heading text-vv-orange text-xs uppercase tracking-widest2 mb-4">The Mission</p>
        <p className="font-heading font-black text-white uppercase leading-none" style={{ fontSize: "clamp(1.8rem, 4vw, 3rem)" }}>
          &ldquo;I am not ashamed<br />of the Gospel.&rdquo;
        </p>
        <p className="font-heading text-xs uppercase tracking-widest2 text-white/40 mt-3">Romans 1:16</p>
        <Link href="/collections/kings-collection" className="inline-block mt-8 border border-white/30 text-white font-heading text-xs font-semibold uppercase tracking-widest2 px-8 py-3 hover:bg-white hover:text-vv-black transition-colors duration-300">
